    ...
    <div class="mx-auto max-w-7xl px-6">
      <div class="flex items-center justify-between border-b-0 border-gray-100 py-4 md:justify-start md:space-x-10">
        ...
        <nav class="hidden space-x-10 md:flex">
          ...
          <a href="/cars" class="text-base font-medium text-gray-500 hover:text-gray-900">Booking</a>
        ...
        <div class="hidden items-center justify-end md:flex md:flex-1 lg:w-0">
          ...
          <a href="/register"
            class="ml-8 inline-flex items-center justify-center whitespace-nowrap rounded-md border border-transparent bg-slate-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-slate-700">Register</a>
        </div>
      </div>
    </div>
