            ...
            <div class="flex flex-wrap">
              ...
              >
                ...
                <form>
                  ...
                  <button
                    type="submit"
                    class="w-full px-6 py-2.5 bg-sky-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out"
                    @click="handleContact"
                  >
                    Send
                  </button>
                  ...
                  >
                    <div class="flex items-start">
                      ...
                      <div class="grow ml-6">
                        ...
                        <p class="text-gray-500">speedyrentals@gmail.com</p>
                        <p class="text-gray-500">0116 888333</p>
                      </div>
                    </div>
                  </div>
                </div>
